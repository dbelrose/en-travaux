...
* **Calendrier coloré** : Vue calendrier avec coloration par logement
* **Photo profil** : Téléchargement automatique de la photo du voyageur
...
* Configuration couleurs logements pour calendrier
...
""",
    ...
    'data': [
        ...
        'views/booking_import_line_calendar_view.xml',
        'views/product_template_color_view.xml',
