...
class AirbnbPdfImporter(models.TransientModel):
    ...
    def _create_partner(self, data):
        ...
        domain = []
        if data.get('phone'):
            domain.append(('mobile', '=', data['phone']))
        ...
        if data.get('first_name') and data.get('last_name'):
            ...
            firstname = data.get('first_name', 'Client')
        ...
        if not partner:
            ...
            partner_vals = {
                'firstname': firstname or 'Client',
                'lastname': lastname or 'Airbnb',
    ...
    def _add_booking_line_to_booking_month(self, booking_line):
        ...
        booking_month = self.env['booking.month'].create_or_update_month(
            property_type_id=booking_line.property_type_id,
