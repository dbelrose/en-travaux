...
--
-- Table structure for table `egw_jinn_sites`
--

DROP TABLE IF EXISTS `egw_jinn_sites`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `egw_jinn_sites` (
  ...
  `object_scan_prefix` varchar(100) DEFAULT NULL,
  `jinn_version` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`site_id`)
...
-- Dump completed on 2025-10-22 11:00:39
