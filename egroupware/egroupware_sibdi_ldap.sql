...
--
-- Table structure for table `sibdi_ldap`
--

DROP TABLE IF EXISTS `sibdi_ldap`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sibdi_ldap` (
  ...
  KEY `egw_addressbook_n_fn` (`n_fn`),
  KEY `egw_addressbook_contact_email` (`contact_email`)
...
-- Dump completed on 2025-10-22 11:01:20
