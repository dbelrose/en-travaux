...
class CpsFeuilleModele(models.Model):
    ...
    ligne_ids = fields.One2many('cps.feuille.soins.modele.ligne', 'modele_id', string='Lignes d\'actes')
...
class CpsFeuilleModeleLigne(models.Model):
    ...
    modele_id = fields.Many2one('cps.feuille.soins.modele', required=True, ondelete='cascade')
    sequence = fields.Integer(default=10)
    acte_type_id = fields.Many2one('cps.acte.type', string='Type d\'acte', required=True, ondelete='restrict')
